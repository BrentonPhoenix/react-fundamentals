        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Refactor the text on this page to make this your own project.</li>
                    <li>This app simply scratches the surface on what is possible with React.</li>
                    <li>We have tried to collect the very best resources for this app, and we have cided those <Link to='/resources'>Here</Link>.</li>
