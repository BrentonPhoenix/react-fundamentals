...
import TimePA from '../apps/timer-apps/TimePiecesApp'
        ...
        <div className='sidebar'>
            <div className='sidebar-list-styling'>
                <ul className='sidebar-list list-unstyled'>
                    ...
                    <li><Link to='/nytApp'>nytimes</Link></li>
                </ul>
            </div>
